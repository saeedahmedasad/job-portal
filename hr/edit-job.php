          ...
          <div class="form-section">
            ...
            <div class="form-group">
              ...
              <input type="number" id="vacancies" name="vacancies" class="form-control"
                value="<?php echo htmlspecialchars($formData['vacancies']); ?>" min="1" max="100" step="1">
            </div>
          </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="number" id="salary_min" name="salary_min" class="form-control"
                  value="<?php echo htmlspecialchars($formData['salary_min']); ?>" placeholder="50000" min="0" step="100">
              </div>
              <div class="form-group">
                <label for="salary_max">Maximum Salary ($/year)</label>
                <input type="number" id="salary_max" name="salary_max" class="form-control"
                  value="<?php echo htmlspecialchars($formData['salary_max']); ?>" placeholder="80000" min="0" step="100">
              </div>
            </div>
